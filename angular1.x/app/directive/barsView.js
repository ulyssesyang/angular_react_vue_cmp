angular.module('angularApp')
    .directive('barsView', ['angularService', '$timeout', function(angularService, $timeout) {
        return {
            restrict: 'AEC',
            scope: {
                data: '='
        ...
        function renderView($scope, $element, $attrs) {
            ...
            var updataChart = function(data) {
                var rect = svg.selectAll("rect").data(data, function(d) { return d.id; });
                console.log(rect);
            }
